...
namespace mswasm_detail {
  ...
  struct convert_type_to_wasm_type
  {
    ...
    using type = void;
    // mswasm has no void type so use i32 for now
    static constexpr mswasm_rt_type_t mswasm_type = MSWASM_RT_I32;
  };
  ...
  {
    using type = uint64_t;
    static constexpr mswasm_rt_type_t mswasm_type = MSWASM_RT_I64;
  };
  ...
  {
    using type = T;
    static constexpr mswasm_rt_type_t mswasm_type = MSWASM_RT_F32;
  };
  ...
  {
    using type = T;
    static constexpr mswasm_rt_type_t mswasm_type = MSWASM_RT_F64;
  };
  ...
  {
    // pointers are handles in MSWASM
    using type = void*;
    static constexpr mswasm_rt_type_t mswasm_type = MSWASM_RT_HANDLE;
  };
